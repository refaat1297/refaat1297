<template>
  <div itemscope="primaryImageOfPage" class="logo-mask">
    <svg id="logo-anim" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="256"
         height="256"
         viewBox="0 0 256 256">
      ...
      <g id="XMLID_10_">
        <defs>
          <path id="XMLID_4_" d="M54.9 147.2l80-70h-33.5l-80 70L122 235.3h33.5L54.9 147.2z"
                style="stroke-dasharray: 548, 550; stroke-dashoffset: 0;">
        ...
        <linearGradient id="XMLID_9_" gradientUnits="userSpaceOnUse" x1="-169.589" y1="333.156" x2="21.795" y2="333.156"
        ...
        <path id="XMLID_3_" d="M154.6 249.8L37.8 147.2c8.3-8.3 91.4-81.4 91.4-81.4" class="st0"
              style="stroke-dasharray: 278, 280; stroke-dashoffset: 0;"></path>
      </g>
      <g id="XMLID_6_">
        <g id="XMLID_7_">
          <defs>
            <path id="XMLID_2_"
                  ...
                  style="stroke-dasharray: 926, 928; stroke-dashoffset: 0;"></path>
          </defs>
          ...
          <path id="XMLID_1_"
                ...
                class="st1" style="stroke-dasharray: 461, 463; stroke-dashoffset: 0;"></path>
        </g>
      </g>
    </svg>
  </div>
